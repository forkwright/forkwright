...
Specification and requirements for a web runtime where operator and agents share one capability surface - browsing, ingesting, querying, and acting - instead of splitting human and machine workflows into separate stacks. Design documents only, no implementation.

`AGPL-3.0-or-later`

## Professional

**Former:** Data Scientist & AI Systems Architect at Summus Global - clinical NLP, medical taxonomy, and GenAI analysis infrastructure. USMC Captain, Finance Officer. Cybersecurity research with Clarkson Aerospace & AFRL.
