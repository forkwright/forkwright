...
Five projects share a naming philosophy ([gnomon](gnomon.md)), a unified [development methodology](WORKFLOW.md), and a conviction that the tools you depend on should be tools you own.
